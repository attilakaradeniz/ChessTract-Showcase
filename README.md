...
Developed by an active tournament player and software engineer with a passion for clean code architecture. Due to the proprietary nature of the custom OCR-to-PGN algorithmic parsers, this repository serves as a showcase. Bug reports, feature requests, and discussions are always welcome!
